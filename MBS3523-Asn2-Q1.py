...
while True:
    ...
    if results.detections != None:
        for face in results.detections:
            ...
            x1 = int(boundingBox.xmin * 640)
            y1 = int(boundingBox.ymin * 480)
            x2 = int((boundingBox.xmin + boundingBox.width) * 640)
            y2 = int((boundingBox.ymin + boundingBox.height) * 480)
            pt1 = (x1, y1)
            pt2 = (x2,y2)
